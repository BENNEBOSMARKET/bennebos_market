@section('page_title')
    {{ __('seller.edit_bid_deals_title') }}
@endsection
<div>
    <style>
        #customSwitchSuccess {
        ...
        <div class="col-xl-7">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('seller.information') }}</h4>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div>
                                <select class="form-control" id="category" wire:model="category">
                                    <option class="text-dark"class="text-dark" value="">{{ __('seller.select_category') }}</option>
                    ...
                    <div class="row mb-3">
                        <label for="" class="col-sm-3"> {{ __('seller.sub_sub_category_star') }}</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="minqty"> {{ __('seller.product_price') }}</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="minqty" placeholder="{{ __('seller.placeholder_enter_price') }}"
                                   wire:model="price" />
                            @error('price')
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="minqty"> {{ __('seller.add_new_quantity') }}</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="minqty" placeholder="{{ __('seller.placeholder_enter_qty') }}"
                                   wire:model="quantity" />
                            @error('quantity')
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
    ...
    <div class="row justify-content-center">
        <div class="col-xl-7">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="unit_price">{{ __('seller.model') }}<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control"
                                   placeholder="{{ __('seller.enter_model') }}" wire:model="model_no" />
                            @error('model_no')
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="unit_price"> {{ __('seller.certification') }}<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control"
                                   placeholder="{{ __('seller.enter_certification') }}" wire:model="certification" />
                            @error('certification')
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="unit_price"> {{ __('seller.add_new_sku') }}<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control"
                                   placeholder="{{ __('seller.placeholder_enter_sku') }}" wire:model="sku" />
                            @error('sku')
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="unit_price">  {{ __('seller.condition') }}<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control"
                                   placeholder=" {{ __('seller.enter_condition') }}" wire:model="condition" />
                            @error('condition')
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
                        </div>
        ...
        <div class="col-xl-7">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        <label for="" class="col-sm-3 col-form-label">{{ __('seller.thumbnail_image') }} <br><small
                        ...
                        <div class="col-sm-9">
                            ...
                            @if ($description_photo)
                                <img src="{{$description_photo}}" width="80" class="mt-2 mb-2" />
                            @endif
                            @error('description_photo')
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
                            <div wire:loading="product_img" wire:target="product_img" wire:key="product_img"
                                 style="font-size: 12.5px;" class="mr-2"><i
                                    class="fa fa-spinner fa-spin mt-3 ml-2"></i> Uploading</div>

                            @if($new_description_photo != '')
                                <img src="{{ $new_description_photo }}" width="120"
                                     class="mt-2 mb-2" />
                            @endif
                        </div>
                    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-7">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3  ">
                        <label class="col-sm-3 col-form-label" for="gallery_images"> {{ __('seller.product_images') }}</label>
                        <div class="col-sm-9">
                            <input class="form-control mb-2" type="file" wire:model="product_img" />
                            @error('product_img')
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
                            <div wire:loading="product_img" wire:target="product_img" wire:key="product_img"
                            ...
                            @if($new_product_img != '')
                                <img src="{{ $new_product_img }}" width="120"
                                     class="mt-2 mb-2" />
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col">
                    <div class="row mb-3  ">
                        <label class="col-sm-3 col-form-label" for="gallery_images"> {{__('seller.gallery_images_big_deals')}}</label>
                        <div class="col-sm-9">
                            ...
                            <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                            @enderror
                            <div wire:loading="image" wire:target="image" wire:key="image"
                                 style="font-size: 12.5px;" class="mr-2"><i
                                    class="fa fa-spinner fa-spin mt-3 ml-2"></i> Uploading</div>

                            @if($new_image != '')
                                <img src="{{ $new_image }}" width="120"
                                     class="mt-2 mb-2" />
                            @endif
...
<div class="row @if($tabStatus != 4) d-none @endif">
    <div class="row justify-content-center">
        <div class="col-xl-7">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('seller.note_page') }}</h4>
                </div>
                <div class="card-body">


                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="meta_description">{{ __('seller.note') }}</label>
                        <div class="col-sm-9">
                            <textarea type="text" class="form-control" style="height: 200px;" id="meta_description" placeholder="{{ __('seller.enter_note') }}" wire:model="note"></textarea>
                    ...
                    <form wire:submit.prevent='updateProduct'>
                        <div class="row justify-content-center">
                            <div class="col-xl-7 text-end">
                                ...
                                <button type="submit" style="padding: 3px 10px;" class="btn btn-primary">{!! loadingStateWithProcess('updateProduct', 'Store Product') !!}</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="updateProduct">
                    ...
                    <div class="mb-3 row">
                        <label for="" class="col-sm-3 col-form-label"></label>
                        <div class="col-sm-9">
                            <button type="submit" class="btn btn-sm btn-primary">{!! loadingStateWithText('updateProduct', 'Submit') !!}</button>
                            <button type="button" class="btn btn-sm btn-danger"
                                    data-bs-dismiss="modal">Cancel</button>
                        </div>
                    </div>
