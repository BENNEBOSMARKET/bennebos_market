                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control"
                                           placeholder="Enter Feet" wire:model="feet" />
                                    @error('feet')
                                    <span class="text-danger" style="font-size: 12.5px;">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row mb-3  ">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div wire:loading="main_photo" wire:target="main_photo" wire:key="main_photo" style="font-size: 12.5px;" class="mr-2"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> {{ __('seller.uploading') }}</div>


                                </div>
                            </div>
                            <div class="card-header">
                                <h6 class="float-start"><strong>photos</strong></h6>
