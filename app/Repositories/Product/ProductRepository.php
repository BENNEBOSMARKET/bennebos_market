...
class ProductRepository extends BaseRepository implements ProductRepositoryInterface
{
    ...
    public function getSomeStatisitcsProducts($limit){
        ...
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo");
        //deals of the day
        $products_data['deals_of_day'] = (Product::leftJoin("sellers","products.user_id", "=","sellers.id")
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('products.deal_of_day', 1)
        ->orderBy('products.id', 'DESC')
        ->get());
        $products_data['new_arrivals'] = (Product::leftJoin("sellers","products.user_id", "=","sellers.id")
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('products.new_arrival', 1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('best_selling',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('top_ranked',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('dropshipping',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('true_view',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('best_big_deal',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('big_deal_new_arrival',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('big_deal_most_viewed',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('deal_of_season',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('big_needs',1)
        ->orderBy('products.id', 'DESC')
        ->get());
        ...
        ->where('products.status',1)
        ->limit($limit)
        ->select("products.slug", "products.gallery_image", "products.name","products.thumbnail","products.unit_price","products.id", "products.total_review", "products.avg_review","products.shipping", "sellers.name as seller_name", "sellers.avatar as seller_logo")->where('big_quantity',1)
        ->orderBy('products.id', 'DESC')
        ->get());
