    ...
    public function toArray($request)
    {
        ...
        */
        ...
        return [
            ...
            */
            "seller" => $this->seller,
            "seller_address" => shop($this->seller_id)->address ." ".shop($this->seller_id)->state_name ." ".shop($this->seller_id)->country_name,
            "seller_country" => shop($this->seller_id)->country_name,
            "seller_country_flag" => shop($this->seller_id)->country_flag,
            "supplier_products" => new CategoryProductResource(Product::where("seller_id",$this->seller_id)->where("product_id" ,"!=",$this->id)->take(8)->get()),
